...
// Qn-12 if a number is even return 1 or else return -1

// function booleanInteger(val3) {
//   if (val3 % 2 == 0) {
//     return 1;
//   } else {
//     return -1;
...
// console.log(booleanInteger(19));
// console.log(booleanInteger(6));

// // check if the user is logged in and subcribbed

// function isLoggedInAndSubscribed(loginStatus, substatus) {
//   if (loginStatus === "LOGGED_IN" && substatus === "SUBSCRIBED") {
//     return true;
//   } else {
//     return false;
//   }
...
// console.log(isLoggedInAndSubscribed("LOGGED_IN", "SUBSCRIBEDE"));
// console.log(isLoggedInAndSubscribed("LOGGED_IN2", "SUBSCRIBED"));

// check if the user is logged in OR subcribbed
